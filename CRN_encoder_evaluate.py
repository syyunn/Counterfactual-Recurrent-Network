...
def fit_CRN_encoder(
    ...
    if b_hyperparam_opt: # default is False; not doing.
        ...
        for simulation in range(num_simulations):
            ...
            hyperparams["rnn_hidden_units"] = int(
...
def test_CRN_encoder(
    ...
    rmse = (np.sqrt(np.mean(mse))) / 1150 * 100  # Max tumour volume = 1150; 8622
    rmse = (np.sqrt(np.mean(mse))) / 8622 * 100  # Max tumour volume = 1150; 8622
